...
async function main() {
  ...
  const categories = await Promise.all([
    prisma.category.upsert({ where: { name: 'Hot Drinks' },  update: {}, create: { name: 'Hot Drinks',  active: true } }),
    prisma.category.upsert({ where: { name: 'Cold Drinks' }, update: {}, create: { name: 'Cold Drinks', active: true } }),
    prisma.category.upsert({ where: { name: 'Food' },        update: {}, create: { name: 'Food',        active: true } }),
    prisma.category.upsert({ where: { name: 'Desserts' },    update: {}, create: { name: 'Desserts',    active: true } }),
  ]);
